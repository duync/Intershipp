 ...
 * @author khang
 */
@WebServlet(name = "GetAccountCustomer", urlPatterns = {"/GetAccountCustomer"})
public class GetAccountCustomer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (yeucau.equals("laythongtin")) {
            if (user != null) {
                session.setAttribute("newcus", user);
                page = "/WEB-INF/views/Customer/updateinfo.jsp";
            } else {
