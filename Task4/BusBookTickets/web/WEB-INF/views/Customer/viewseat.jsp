...
<body>
    ...
    <div>
        <table style="position: relative; top: 50px; left: 10%; width: 81.5%">
            <tr>
                <td style="margin-right: -50px; ">
                    <p style="border: 5px solid orange; width: 95%; height: 45px; color: black; text-align: center; border-radius: 10px; margin-right: 0px; padding-top: 3px;"> 1. Kết quả tìm</p>
                </td>
                <td style="width: 36%;">
                    <p style="border: 5px solid orange; width: 95%; height: 45px; color: white; text-align: center; border-radius: 10px; background-color: orange; padding-top: 3px;"> 2. Thông tin bổ sung</p>
                </td>
                <td>
                    <p style="border: 5px solid orange; width: 95%; height: 45px; color: black; text-align: center; border-radius: 10px;  padding-top: 3px;"> 3. Xác nhận</p>
                </td>
            </tr>
        </table>
    </div>
    ...
    <header class="dh-header-non-rectangular" style="position: relative; top: -40px; height: 370px;">
        <form action="BookTicketServlet?yeucau=bookticket&&txtBus=${txtBus}&&txtiduser=${Iduser}&&txtdate=${dateBook}" method="post">
            ...
            <div style="position: relative; left: 1025px; top: -65px; ">
                <button class="btn btn-warning" style="width: 100px; border-radius: 10px;" type="submit">Book</button>
            </div>
        </form>
    </header>
